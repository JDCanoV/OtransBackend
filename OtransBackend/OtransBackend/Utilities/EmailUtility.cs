...
namespace OtransBackend.Utilities
{
    public class EmailUtility
    {
        ...
        private readonly string _smtpUsername = "softwareotrans@gmail.com";  // Cambiar por tu correo
        private readonly string _smtpPassword = "iaokzrmxhtcmjcue"; // Cambiar por tu contraseña
